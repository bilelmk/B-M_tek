...
$requet = $connexion->prepare('DELETE FROM Produit WHERE Nom= :Nom')  ;
...
echo ('
    ...
    <div class="col-10 col-sm-6 offset-1 offset-sm-3 " style="margin-bottom:100px">
        <a href="../interface admin/supprimer_produit.php " style="text-decoration:none"><button type="button" class="btn btn-warning btn-block btn-lg" >
         Supprimer d\'autres produits
        </button>
        </a>
    </div>    
