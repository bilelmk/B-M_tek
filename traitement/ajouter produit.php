...
$requet = $connexion->prepare('INSERT INTO Produit (Nom,Prix,Categorie,Description,Image_name)
VALUES(:Nom, :Prix, :Categorie, :Description, :Image_name)') ;
...
echo ('
    ...
    <div class="col-10 col-sm-6 offset-1 offset-sm-3 " style="margin-bottom:100px">
        <a href="../interface admin/ajouter_produit.php " style="text-decoration:none"><button type="button" class="btn btn-warning btn-block btn-lg" >
