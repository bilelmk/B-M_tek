...
<!--form pour modifier des produit-->
<?php 
...
<div class="row ">
        <div class="col-12 col-sm-4 ajout d-none d-sm-block mt-4 rounded-circle">
            <i class="unlock_logo fa fa-wrench"></i>
         </div>

        <div class="col-12 col-sm-7 ml-sm-5">

<form method="POST" action="../traitement/modifier produit.php" enctype="multipart/form-data">

  <div class="form-group row">
    <label class="col-12" >Nom du produit</label>
    <div class="col-12">
  ...
  <div class="form-group row">
    ...
    <label class="col-12 col-sm-3" for="Nouveau_nom">Nouveau Nom </label>
    ...
    <label class="col-12 col-sm-3" for="myimage"> Nouvelle image</label>
    <div class="col-12 col-sm-9">
        <input type="FILE" class="form-control-file" name="myimage" id="myimage">
    </div>
    </div>
